...
public record RecipeTemplateStep(UUID id,RecipeStepType type,String instruction,int sortOrder,UUID cookingProcessId,
    ...
    public RecipeTemplateStep(UUID id,RecipeStepType type,String instruction,int sortOrder,UUID cookingProcessId,
            List<CookingProcessBinding> parameterBindings){this(id,type,instruction,sortOrder,cookingProcessId,parameterBindings,null);}
    public RecipeTemplateStep(UUID id,String instruction,int sortOrder){this(id,RecipeStepType.TEXT,instruction,sortOrder,null,List.of(),null);}
}
