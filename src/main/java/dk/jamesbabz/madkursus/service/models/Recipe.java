...
public record Recipe(UUID id, UUID userId, UUID sourceTemplateId, String name, String description, Instant createdAt,
                     ...
                     List<String> equipmentOverview,List<PreparedComponent> preparedComponents,CarbohydrateResult carbohydrates) {
 public Recipe(UUID id,UUID userId,UUID sourceTemplateId,String name,String description,Instant createdAt,Instant updatedAt,List<RecipeIngredient> ingredients,List<RecipeStep> steps,List<RecipePreparationStep> preparationSteps,List<RecipeEquipmentRequirement> equipmentRequirements,List<String> equipmentOverview,List<PreparedComponent> preparedComponents){this(id,userId,sourceTemplateId,name,description,createdAt,updatedAt,ingredients,steps,preparationSteps,equipmentRequirements,equipmentOverview,preparedComponents,null);}
