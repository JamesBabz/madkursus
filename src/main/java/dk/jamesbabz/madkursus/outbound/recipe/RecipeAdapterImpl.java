...
public class RecipeAdapterImpl implements RecipePort {
    ...
    private void addChildren(RecipeEntity entity,Recipe model) {
        ...
        model.preparationSteps().forEach(value->entity.addPreparationStep(new RecipePreparationStepEntity(value.id(),value.instruction(),value.sortOrder())));
