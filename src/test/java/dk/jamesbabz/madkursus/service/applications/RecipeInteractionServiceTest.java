...
class RecipeInteractionServiceTest {
 @Mock RecipeService recipes; @Mock ProductService products; @Mock InventoryService inventory; @Mock ShoppingListService shopping; @Mock RecipeCookHistoryPort history; @Mock CurrentUserProvider currentUser;
 @InjectMocks RecipeInteractionService service;
 ...
 @BeforeEach void inventoryDefault(){lenient().when(inventory.getAll()).thenReturn(List.of());}
